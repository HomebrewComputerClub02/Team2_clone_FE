import { MusicProfileProps } from '../components/molecules/MusicController';
...
export const AlbumTrack: Track[] = [
  {
    ...
    update: '6일 전',
    time: 240,
    musicLink: '/mp3/pardise_city.mp3',
    artistLink: '',
    albumLink: '',
  },
  {
    ...
    update: '4주 전',
    time: 180,
    musicLink: '/mp3/november_rain.mp3',
    artistLink: '',
    albumLink: '',
  },
  {
    ...
    update: '4주 전',
    time: 186,
    musicLink: '/mp3/paradise_city.mp3',
    artistLink: '',
    albumLink: '',
  },
  {
...
export const ArtistTrack: Track[] = [
  {
    imgSrc: 'https://i.scdn.co/image/ab67616d00004851d5d11b6ac4242aaa41c8be69',
    music: 'ONLY',
    artist: '이하이',
...
export const Tracks: Track[] = [
  ...
  },
  {
    ...
    update: '4주 전',
    time: 186,
    musicLink: '/mp3/knocking_on_heavens_door.mp3',
    artistLink: '',
    albumLink: '',
  },
  {
